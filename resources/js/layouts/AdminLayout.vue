        ...
        <ul class="hidden md:flex gap-8">
          ...
          <li>
            <router-link
              to="/companies"
              class="font-medium transition-colors"
              :class="isActive('/companies') ? 'text-purple-500' : 'text-gray-700 hover:text-purple-500'"
            >
              Companies
            </router-link>
          </li>
          <li>
            <router-link
              to="/rentals"
              class="font-medium transition-colors"
              :class="isActive('/rentals') ? 'text-purple-500' : 'text-gray-700 hover:text-purple-500'"
            >
              Rentals
            </router-link>
          </li>
          ...
          <li>
            <router-link
              to="/customers"
              class="font-medium transition-colors"
              :class="isActive('/customers') ? 'text-purple-500' : 'text-gray-700 hover:text-purple-500'"
            >
              Customers
            </router-link>
          </li>
        ...
        <ul class="flex flex-col gap-2">
          ...
          <li>
            <router-link
              to="/companies"
              class="block py-2 font-medium"
              :class="isActive('/companies') ? 'text-purple-500' : 'text-gray-700'"
              @click="mobileMenuOpen = false"
            >
              Companies
            </router-link>
          ...
          <li>
            <router-link
              to="/rentals"
              class="block py-2 font-medium"
              :class="isActive('/rentals') ? 'text-purple-500' : 'text-gray-700'"
              @click="mobileMenuOpen = false"
            >
              Rentals
            </router-link>
          ...
          <li>
            <router-link
              to="/customers"
              class="block py-2 font-medium"
              :class="isActive('/customers') ? 'text-purple-500' : 'text-gray-700'"
              @click="mobileMenuOpen = false"
            >
              Customers
            </router-link>
